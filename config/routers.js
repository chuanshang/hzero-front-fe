module.exports = [
   ...
   */
  {
    ...
    components: [
      ...
      // 服务区域详情
      {
        path: '/amdm/maint-sites/detail/:id',
        models: ["amdm/maintSites"],
