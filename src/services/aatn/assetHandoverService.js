...
export async function searchAssetHandover(params) {
  ...
  return request(`${prefix}/${param.tenantId}/handover-order-headers`, {
    method: 'GET',
    query: param,
  });
}
 ...
 * 提交
 * @async
 * @function submitAssetHandover
 * @param {object} params - 请求参数
 * @param {!string} params.tenantId - 租户Id
 * @param {!string} params.handoverHeaderId - 订单头ID
 * @returns {object} fetch Promise
 */
export async function submitAssetHandover(params) {
  return request(`${prefix}/${params.tenantId}/handover-order-headers/submit`, {
    method: 'PUT',
    body: params.data,
  });
}
 ...
 * 保存
 * @async
 * @function saveAssetHandover
 * @param {object} params - 请求参数
 * @param {!string} params.tenantId - 租户Id
 * @param {!string} params.data - 归还单信息
 * @returns {object} fetch Promise
 */
export async function saveAssetHandover(params) {
  return request(`${prefix}/${params.tenantId}/handover-order-headers`, {
    method: 'POST',
    body: params.data,
  });
}
 ...
 * 删除
 * @async
 * @function deleteAssetHandover
 * @param {object} params - 请求参数
 * @param {!string} params.tenantId - 租户Id
 * @param {!string} params.data - 归还单信息
 * @returns {object} fetch Promise
 */
export async function deleteAssetHandover(params) {
  return request(`${prefix}/${params.tenantId}/handover-order-headers`, {
    method: 'DELETE',
    body: params.data,
  });
