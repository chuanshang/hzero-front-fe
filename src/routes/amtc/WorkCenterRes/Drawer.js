      ...
      >
        <Form>
          ...
          >
            ...
            })(<Lov code="AMTC.WORKCENTERS" queryParams={{ organizationId: tenantId }} />)}
          </Form.Item>
          ...
          <Form.Item
            ...
            {...formLayout}
          >
            {getFieldDecorator('plannerFlag', {})(<Switch />)}
          </Form.Item>
          <Form.Item
            label={intl.get(`${commonPromptCode}.workcenterStaff`).d('技能类型负责人')}
            {...formLayout}
          >
