...
class AssetModal extends PureComponent {
  ...
  handleRemoveColumn(columns) {
    const { productTypeFlag, assetSetFlag, templateStatus } = this.props;
  ...
  render() {
            ...
            <Form.Item>
              {record.$form.getFieldDecorator('productCategoryId', {
                ...
                <Lov
                  ...
                  // textValue={
                  //   !isUndefined(productCategoryName[record.templateToAssetId])
                  //     ? productCategoryName[record.templateToAssetId]
        ...
        render: (_, record) =>
          ['create', 'update'].includes(record._status) ? (
            <Form.Item>
              ...
              })(<InputNumber allowThousandth min={0} precision={2} disabled />)}
            </Form.Item>
          ) : (
    ...
    return (
      <Modal
        ...
        onOk={templateStatus === 'PRESET' ? onSave : onCancel}
        confirmLoading={saveLoading}
        okText={
          templateStatus === 'PRESET'
          ...
          <Row style={{ marginBottom: 10 }}>
            <Col>
              <Button
                ...
                style={{
                  marginRight: 10,
                  display: templateStatus === 'PRESET' ? 'inline' : 'none',
                }}
              >
              ...
              <ExcelExport
                requestUrl={`${HALM_PPM}/v1/${tenantId}/budget-template/item-asset-export/${templateItemId}`}
              />
            </Col>
          </Row>
          <Row>
