...
import { Input, Form, Button, Select, Row, Col, DatePicker } from 'hzero-ui';
...
@CacheComponent({ cacheKey: 'aatn/transfer-order/detail' })
          ...
          <Col {...FORM_COL_3_4_LAYOUT}>
            <Row {...SEARCH_FORM_ROW_LAYOUT}>
              <Col {...FORM_COL_3_LAYOUT}>
                <Form.Item
                  label={intl.get(`${transferOrderModelPrompt}.transactionTypeId`).d('事务类型')}
                  {...SEARCH_FORM_ITEM_LAYOUT}
                >
              ...
              <Col {...FORM_COL_3_LAYOUT}>
                <Form.Item
                  label={intl.get(`${transferOrderModelPrompt}.processStatus`).d('处理状态')}
                  {...SEARCH_FORM_ITEM_LAYOUT}
                >
              ...
              <Col {...FORM_COL_3_LAYOUT}>
                <Form.Item
                  label={intl.get(`${transferOrderModelPrompt}.principalPersonId`).d('负责人')}
                  {...SEARCH_FORM_ITEM_LAYOUT}
                >
            ...
            >
              <Col {...FORM_COL_3_LAYOUT}>
                <Form.Item
                  label={intl.get(`${transferOrderModelPrompt}.transferNum`).d('事务处理单编号')}
                  {...SEARCH_FORM_ITEM_LAYOUT}
                >
              ...
              <Col {...FORM_COL_3_LAYOUT}>
                <Form.Item
                  label={intl.get(`${transferOrderModelPrompt}.titleOverview`).d('标题概述')}
                  {...SEARCH_FORM_ITEM_LAYOUT}
                >
              ...
              <Col {...FORM_COL_3_LAYOUT}>
                <Form.Item
                  label={intl
                    .get(`${transferOrderModelPrompt}.planStartDateFrom`)
                    .d('计划执行日期从')}
                  {...SEARCH_FORM_ITEM_LAYOUT}
                >
            ...
            >
              <Col {...FORM_COL_3_LAYOUT}>
                <Form.Item
                  label={intl
                    .get(`${transferOrderModelPrompt}.planStartDateTo`)
                    .d('计划执行日期至')}
                  {...SEARCH_FORM_ITEM_LAYOUT}
                >
              ...
              <Col {...FORM_COL_3_LAYOUT}>
                <Form.Item
                  label={intl
                    .get(`${transferOrderModelPrompt}.planEndDateFrom`)
                    .d('计划完成日期从')}
                  {...SEARCH_FORM_ITEM_LAYOUT}
                >
              ...
              <Col {...FORM_COL_3_LAYOUT}>
                <Form.Item
                  label={intl.get(`${transferOrderModelPrompt}.planEndDateTo`).d('计划完成日期至')}
                  {...SEARCH_FORM_ITEM_LAYOUT}
                >
