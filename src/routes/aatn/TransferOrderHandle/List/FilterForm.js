...
class FilterForm extends PureComponent {
  ...
  render() {
    const promptCode = 'aatn.transferOrderHandle.model.transferOrderHandle';
    const { form, tenantId, approveStatus, transferOrderLineStatus } = this.props;
                ...
                <Row {...SEARCH_FORM_ROW_LAYOUT}>
                  <Col {...FORM_COL_3_4_LAYOUT}>
                    ...
                    >
                      <Col {...FORM_COL_3_LAYOUT}>
                        <Form.Item
                          label={intl.get(`${promptCode}.transferNum`).d('事务处理单编号')}
                          {...SEARCH_FORM_ITEM_LAYOUT}
                        >
